...
<tr><td>$T_Owner:</td><td><a href="./userinfo.php?user=$owner" title="$fullname" target="_parent">$owner</a></td></tr>
<tr><td>$T_Short_url:</td><td><a href="/cs/$id" target="_parent">$serverhome/cs/$id</a>
<tr><td>$T_Summary:</td><td>$summary</td></tr>
<tr><td>$T_Language_notes:</td><td>$langnotes</td></tr>
<tr><td>$T_Language:</td><td><a href="./?sl=$sl" target="_parent">$sl</a></td></tr>
<tr><td>$T_Level:</td><td><a href="./?sl=$sl&amp;levelMin=$cefr&amp;levelMax=$cefr" target="_parent">$cefr</a> <span style="color:grey;font-size:70%;padding-left:1em">($level)</span></td></tr>
...
<tr><td style="vertical-align:bottom">$T_Licence:</td><td><img src="/icons-smo/CC-$licence.png" alt=""> <a href="https://creativecommons.org/licenses/$licenceLC/4.0/">Creative Commons $licence</a></td></tr>
