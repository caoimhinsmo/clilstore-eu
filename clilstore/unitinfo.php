...
<li><a href="/cs/$id" title="Back to Unit $id" target="_parent">Unit $id</a></li>
</ul>
EOBUT;
...
<tr><td>Owner:</td><td><a href="./userinfo.php?user=$owner" title="$fullname" target="_parent">$owner</a></td></tr>
<tr><td>Short&nbsp;URL:</td><td><a href="/cs/$id" target="_parent">$serverhome/cs/$id</a>
...
<tr><td>Language:</td><td><a href="./?sl=$sl" target="_parent">$sl</a></td></tr>
<tr><td>Level:</td><td><a href="./?sl=$sl&amp;levelMin=$cefr&amp;levelMax=$cefr" target="_parent">$cefr</a> <span style="color:grey;font-size:70%;padding-left:1em">($level)</span></td></tr>
