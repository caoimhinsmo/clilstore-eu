...
<form>
<select name="hl" style="display:inline-block;background-color:#eef;margin:0 4px" onchange="atharraichCanan(this.options[this.selectedIndex].value)" class="mySelect">
$options</select>
</form>
END_selCanan;
      $mdNavbar = <<<EOD_NAVBAR
